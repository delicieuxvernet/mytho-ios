...
enum MostLikelyBank {
    ...
    static let detraqueCards: [MostLikelyCard] = [
        ...
        MostLikelyCard(id: "mst_266", text: "envoyer un CV à trois heures du matin « en manifestant »"),
        ...
        MostLikelyCard(id: "mst_269", text: "prendre l'accent d'un inconnu en lui parlant"),
        MostLikelyCard(id: "mst_270", text: "répondre « présent » quand on crie son prénom dans la rue"),
        MostLikelyCard(id: "mst_271", text: "finir la soirée à parler à un mur de bon conseil"),
        ...
        MostLikelyCard(id: "mst_275", text: "draguer en récitant son CV"),
        MostLikelyCard(id: "mst_276", text: "payer l'addition en pièces rouges par vengeance"),
        ...
        MostLikelyCard(id: "mst_280", text: "jurer avoir vu un fantôme dans le frigo"),
        ...
        MostLikelyCard(id: "mst_284", text: "adopter l'accent québécois pour la soirée entière"),
        ...
        MostLikelyCard(id: "mst_288", text: "gagner un concours de danse qui n'existait pas"),
        ...
        MostLikelyCard(id: "mst_292", text: "imposer une chorégraphie au groupe pour l'éternité"),
        ...
        MostLikelyCard(id: "mst_295", text: "mettre ses lunettes de soleil pour pleurer en boîte"),
        MostLikelyCard(id: "mst_296", text: "draguer le sosie de son ex avant de réaliser que c'était son ex"),
        MostLikelyCard(id: "mst_297", text: "payer un inconnu en compliments"),
        MostLikelyCard(id: "mst_298", text: "déclarer sa flamme par sondage"),
