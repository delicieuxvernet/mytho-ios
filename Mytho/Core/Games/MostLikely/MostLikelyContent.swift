...
enum MostLikelyBank {
    ...
    static let detraqueCards: [MostLikelyCard] = [
        MostLikelyCard(id: "mst_261", text: "finir dans une baignoire à débattre de l'univers à quatre heures"),
        MostLikelyCard(id: "mst_262", text: "se faire virer d'un karaoké pour excès d'émotion"),
        MostLikelyCard(id: "mst_263", text: "pleurer devant la boutique kebab fermée"),
        MostLikelyCard(id: "mst_264", text: "proposer un pacs à son pote de soirée pour les impôts"),
        MostLikelyCard(id: "mst_265", text: "tenter d'adopter le chat du bar"),
        MostLikelyCard(id: "mst_266", text: "se faire sortir d'un fast-food pour avoir voulu aider en cuisine"),
        MostLikelyCard(id: "mst_267", text: "goûter les croquettes du chien par pure curiosité"),
        MostLikelyCard(id: "mst_268", text: "se battre avec un parasol et perdre"),
        MostLikelyCard(id: "mst_269", text: "perdre un concours de regard contre son propre reflet"),
        MostLikelyCard(id: "mst_270", text: "répondre « présent » quand on crie son prénom dans la rue"),
        MostLikelyCard(id: "mst_271", text: "se présenter aux voisins à trois heures « pour faire connaissance »"),
        MostLikelyCard(id: "mst_272", text: "traverser la ville en trottinette avec un meuble"),
        MostLikelyCard(id: "mst_273", text: "se réveiller avec un panneau de signalisation dans le salon"),
        MostLikelyCard(id: "mst_274", text: "créer un compte fan de son propre groupe d'amis"),
        MostLikelyCard(id: "mst_275", text: "se faire tatouer par un inconnu rencontré une heure avant"),
        MostLikelyCard(id: "mst_276", text: "finir à l'aéroport sans billet « pour l'ambiance »"),
        MostLikelyCard(id: "mst_277", text: "finir dans une fontaine municipale"),
        MostLikelyCard(id: "mst_278", text: "lancer un débat sur l'existence des pigeons à cinq heures"),
        MostLikelyCard(id: "mst_279", text: "se tatouer le nom d'un plat"),
        MostLikelyCard(id: "mst_280", text: "réciter son RIB de tête pour prouver qu'il n'est pas bourré"),
        MostLikelyCard(id: "mst_281", text: "monter un business plan sur une nappe et y croire une semaine"),
        MostLikelyCard(id: "mst_282", text: "appeler sa banque « en tant que fidèle client » un lendemain de fête"),
        MostLikelyCard(id: "mst_283", text: "s'endormir dans le taxi commandé par un inconnu"),
        MostLikelyCard(id: "mst_284", text: "fonder une religion autour d'un kebab à quatre heures"),
        MostLikelyCard(id: "mst_285", text: "présenter des excuses officielles à une plante verte"),
        MostLikelyCard(id: "mst_286", text: "organiser des funérailles de poisson rouge avec discours"),
        MostLikelyCard(id: "mst_287", text: "mettre du métal au mariage en prenant la playlist en otage"),
        MostLikelyCard(id: "mst_288", text: "appeler les urgences pour un cœur brisé"),
        MostLikelyCard(id: "mst_289", text: "se réveiller dans la mauvaise ville"),
        MostLikelyCard(id: "mst_290", text: "signer un texto à sa daronne « cordialement »"),
        MostLikelyCard(id: "mst_291", text: "commander quarante nuggets et les défendre un par un"),
        MostLikelyCard(id: "mst_292", text: "envoyer sa position en direct à son ex « par transparence »"),
        MostLikelyCard(id: "mst_293", text: "envoyer un audio de douze minutes pour dire « ok »"),
        MostLikelyCard(id: "mst_294", text: "rédiger un communiqué officiel de rupture"),
        MostLikelyCard(id: "mst_295", text: "sonner chez soi en ayant oublié qu'il vivait seul"),
        MostLikelyCard(id: "mst_296", text: "draguer le sosie de son ex avant de réaliser que c'était son ex"),
        MostLikelyCard(id: "mst_297", text: "prendre un aller simple par vexation"),
        MostLikelyCard(id: "mst_298", text: "offrir sa veste à une statue « qui avait froid »"),
        MostLikelyCard(id: "mst_299", text: "se faire bannir du groupe familial"),
        MostLikelyCard(id: "mst_300", text: "négocier avec le videur au nom de tout le monde")
    ]
}
