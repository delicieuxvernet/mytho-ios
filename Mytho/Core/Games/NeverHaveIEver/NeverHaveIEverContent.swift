...
enum NeverHaveIEverBank {
    ...
    private static let epiceCards: [ConfessionCard] = [
        card(191, "envoyé un sexto au mauvais contact"),
        card(192, "fantasmé sur quelqu'un dans cette pièce"),
        card(193, "fait ça avec quelqu'un de cette pièce"),
        card(194, "menti sur mon nombre"),
        card(195, "simulé pour que ça finisse plus vite"),
        card(196, "eu un plan d'un soir dont j'avais oublié le prénom au réveil"),
        card(197, "gardé les nudes d'un ex « au cas où »"),
        card(198, "fouillé le téléphone de l'autre pendant sa douche"),
        card(199, "fait semblant d'être célibataire en soirée"),
        card(200, "répondu à un « tu dors ? » à 3h en sachant très bien pourquoi"),
        card(201, "fait ça le soir du premier rencard"),
        card(202, "été menotté — pas par la police"),
        card(203, "quitté un rencard pour un meilleur plan le même soir"),
        card(204, "envoyé un nude avec un décor reconnaissable derrière"),
        card(205, "eu un plan au boulot en le niant au boulot"),
        card(206, "dit « c'était une erreur » en le refaisant la semaine d'après"),
        card(207, "enregistré un plan sous un surnom pour ne pas confondre"),
        card(208, "eu deux rencards le même jour, brunch et dîner"),
        card(209, "fait croire que c'était ma première fois"),
        card(210, "attendu qu'on prononce son prénom parce que je l'avais oublié"),
        card(211, "croisé quelqu'un « par hasard » grâce à sa story"),
        card(212, "écrit à mon ex en sachant très bien comment ça finirait"),
        card(213, "présenté un plan à mes parents comme « un ami »"),
        card(214, "répondu « on se refait ça » en bloquant dans la foulée"),
        card(215, "fait ça dans un lieu où on aurait pu me reconnaître"),
        card(216, "fait ça dans les toilettes d'une soirée"),
        card(217, "quitté une chambre par la fenêtre, chaussures à la main"),
        card(218, "laissé un faux numéro avec un seul chiffre changé"),
        card(219, "dit « je t'aime » pendant, sans le penser"),
        card(220, "pleuré après — et menti sur pourquoi"),
        card(221, "vomi dans un sac à main — pas le mien"),
        card(222, "reconstitué ma soirée grâce aux stories des autres"),
        card(223, "juré « plus jamais » la main sur un kebab à 4h du matin"),
        card(224, "ramené le tabouret du bar sans aucun souvenir de comment"),
        card(225, "envoyé 14 vocaux d'affilée après 2h du matin"),
        card(226, "dansé sur une table qui n'a pas tenu"),
        card(227, "embrassé deux personnes dans la même soirée"),
        card(228, "embrassé quelqu'un pour rendre jaloux quelqu'un d'autre"),
        card(229, "fini une soirée tout habillé dans une baignoire"),
        card(230, "déjeuné avec ses parents sans connaître son prénom"),
        card(231, "stalké l'ex de mon ex jusqu'en 2019"),
        card(232, "archivé une conversation au lieu de la supprimer « au cas où »"),
        card(233, "posté une fausse story pour prouver que je sortais"),
        card(234, "répondu « je dors » depuis une autre soirée"),
        card(235, "liké puis retiré le like en priant que rien ne s'affiche"),
        card(236, "écrit puis effacé quinze messages avant d'envoyer « slt »"),
        card(237, "mis un mot de passe sur une app que personne ne pense à ouvrir"),
        card(238, "demandé à un pote de me « kidnapper » par SMS en plein rencard"),
        card(239, "couru — vraiment couru — pour éviter un contrôleur"),
        card(240, "signé le carnet à la place de mes parents"),
        card(241, "menti à mes parents sur ce qui sentait dans ma chambre"),
        card(242, "gardé la monnaie des courses de ma mère"),
        card(243, "lancé « à demain » au videur qui me sortait"),
        card(244, "baissé mon doigt en priant qu'on ne demande pas les détails"),
        card(245, "préparé un mensonge avant cette partie, exactement pour ça"),
        card(246, "trouvé quelqu'un de cette pièce sur une app de rencontre"),
        card(247, "rêvé de quelqu'un d'ici et soutenu son regard le lendemain"),
        card(248, "menti à quelqu'un de cette table, cette semaine"),
        card(249, "été surpris par mes parents — on n'en a jamais reparlé"),
        card(250, "dit « c'est la douche » pour expliquer mes yeux rouges")
    ]
}
