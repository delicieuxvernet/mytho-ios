...
enum NeverHaveIEverBank {
    ...
    private static let epiceCards: [ConfessionCard] = [
        ...
        card(192, "traversé la ville au petit matin dans la tenue de la veille"),
        ...
        card(196, "pensé à quelqu'un d'autre au mauvais moment"),
        ...
        card(202, "reçu un « tu dors ? » et fait semblant de dormir"),
        ...
        card(206, "ri au pire moment possible d'un moment intime"),
        ...
        card(211, "menti à tout le monde ici sur ma vie amoureuse"),
        ...
        card(216, "inventé un rendez-vous médical pour un rencard"),
        card(217, "mis une alarme pour filer avant le réveil de l'autre"),
        ...
        card(221, "sorti un chien qui n'existe pas pour un rendez-vous secret"),
        ...
        card(226, "commenté un physique dans le mauvais groupe"),
        card(227, "dragué le frère ou la sœur d'un pote"),
        card(228, "été délogé d'un endroit public par un agent de sécurité"),
        card(229, "dormi côté mur pour éviter la conversation du matin"),
        card(230, "dit « je t'aime » pendant, sans le penser une seconde"),
        card(231, "simulé, et récidivé"),
        card(232, "transformé « je reste dix minutes » en petit-déjeuner"),
        card(233, "monté une story alibi pour couvrir ma vraie soirée"),
        card(234, "su que c'était une bêtise avant, pendant et après"),
        card(235, "reçu un compliment très précis et très gênant"),
        card(236, "accepté un rencard le lendemain d'un autre rencard"),
        card(237, "reconnu quelqu'un sur une appli et juré de me taire"),
        card(238, "croisé un ancien plan à un entretien d'embauche"),
        card(239, "fait ça avec quelqu'un rencontré le soir même"),
        card(240, "envoyé une photo « artistique » de moi"),
        card(241, "demandé une photo « artistique » en retour"),
        card(242, "effacé une conversation entière pour protéger ma réputation"),
        card(243, "eu un faible pour le ou la coloc de mon plan"),
        ...
        card(247, "regretté à voix haute pendant"),
        card(248, "établi un couvre-feu personnel après un fiasco"),
