...
enum WouldYouRatherBank {
    ...
    private static let base: [Dilemma] = [
        ...
        Dilemma(id: "wyr_011", a: "Te ronger les ongles des pieds", b: "Manger tes croûtes"),
        Dilemma(id: "wyr_012", a: "Boire l'eau de la vaisselle", b: "Manger l'éponge de l'évier"),
        Dilemma(id: "wyr_013", a: "Des mains qui sentent les pieds", b: "Des pieds qui sentent l'aisselle"),
        Dilemma(id: "wyr_014", a: "Éternuer de la morve à chaque bise", b: "Postillonner à chaque phrase"),
        Dilemma(id: "wyr_015", a: "Vomir dans un casque et le remettre", b: "Enfiler un maillot encore trempé de la veille"),
        Dilemma(id: "wyr_016", a: "Te curer le nez et l'essuyer sous la table", b: "Tremper ton doigt dans un cendrier et le lécher"),
        Dilemma(id: "wyr_017", a: "Faire caca sans porte au festival", b: "Vomir dans ton sac en plein rencard"),
        Dilemma(id: "wyr_018", a: "Roter l'odeur de ton dernier repas", b: "Péter le son d'une trompette"),
        Dilemma(id: "wyr_019", a: "Marcher pieds nus dans des toilettes publiques", b: "Dormir dans des draps jamais lavés"),
        Dilemma(id: "wyr_020", a: "Un dentiste qui pue de la bouche", b: "Un coiffeur qui éternue dans tes cheveux"),
        Dilemma(id: "wyr_021", a: "Mâcher un chewing-gum trouvé sous la table", b: "Sucer une pièce ramassée dans la rue"),
        Dilemma(id: "wyr_022", a: "La brosse à dents du coloc à vie", b: "Sa serviette de sport après lui"),
        Dilemma(id: "wyr_023", a: "Faire pipi au lit chez tes beaux-parents", b: "Vomir au mariage de ton meilleur pote"),
        Dilemma(id: "wyr_024", a: "La diarrhée en covoiturage", b: "Le hoquet à un enterrement"),
        Dilemma(id: "wyr_025", a: "Manger un kebab tombé dans le caniveau", b: "Lécher la rampe du métro")
    ]
