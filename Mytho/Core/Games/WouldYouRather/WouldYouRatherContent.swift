...
enum WouldYouRatherBank {
    ...
    static let extreme: [Dilemma] = [
        ...
        Dilemma(id: "wyr_053", a: "Gémir à chaque éternuement", b: "Éternuer à chaque moment intime"),
        Dilemma(id: "wyr_054", a: "Un tatouage du prénom de chaque ex", b: "Un ex avec ton visage tatoué"),
        Dilemma(id: "wyr_055", a: "Ton plan d'hier devient ton boss lundi", b: "Le rencard de ta mère samedi"),
        Dilemma(id: "wyr_056", a: "Finir tous les fonds de verre de la soirée", b: "Lécher le comptoir du bar en entier"),
        Dilemma(id: "wyr_057", a: "Revivre ta pire cuite chaque samedi", b: "Ne plus jamais boire une goutte"),
        Dilemma(id: "wyr_058", a: "Faire l'amour en silence total à vie", b: "En commentant tout à voix haute"),
        Dilemma(id: "wyr_059", a: "Que ta mère commente tes stories de soirée", b: "Que ton boss like tes photos de vacances"),
        Dilemma(id: "wyr_060", a: "Dire ton nombre exact à tes parents", b: "Que tes parents te disent le leur"),
        Dilemma(id: "wyr_061", a: "Que ta peuff ait un goût de paff", b: "Que ta paff ait un goût de peuff"),
        Dilemma(id: "wyr_062", a: "Pleurer bruyamment à chaque orgasme", b: "Rire aux éclats à chaque enterrement"),
        Dilemma(id: "wyr_063", a: "Une seule fois par an, mais parfaite", b: "Tous les jours, toujours moyen"),
        Dilemma(id: "wyr_064", a: "Que ça dure 30 secondes à vie", b: "Que ça dure 3 heures obligatoires"),
        Dilemma(id: "wyr_065", a: "Boire un litre de règles", b: "Boire un litre de sperme"),
        Dilemma(id: "wyr_066", a: "Nager dans une piscine de caca mou", b: "Nager dans une piscine de vomi"),
        Dilemma(id: "wyr_067", a: "Des bites à la place des dents", b: "Chier de la mayonnaise"),
        Dilemma(id: "wyr_068", a: "Vomir des limaces", b: "Chier des cafards qui te gratouillent l'anus"),
        Dilemma(id: "wyr_069", a: "Que tes parents te surprennent en plein acte", b: "Surprendre tes parents en plein acte"),
        Dilemma(id: "wyr_070", a: "Lécher le sol des toilettes d'une boîte", b: "Boire l'eau d'un vase de trois semaines"),
        Dilemma(id: "wyr_071", a: "Des poils pubiens à la place des dents", b: "Des dents à la place des poils pubiens"),
        Dilemma(id: "wyr_072", a: "Un pénis de la taille d'un téton", b: "Des tétons de la taille d'un pénis"),
        Dilemma(id: "wyr_073", a: "Plus jamais de papier toilette", b: "Plus jamais te brosser les dents"),
        Dilemma(id: "wyr_074", a: "Transpirer de la mayonnaise en permanence", b: "Pleurer du vinaigre"),
        Dilemma(id: "wyr_075", a: "Une haleine de vomi permanente", b: "Sentir le poisson pourri en permanence"),
        Dilemma(id: "wyr_076", a: "Chier de la confiture", b: "Pisser de la mayonnaise"),
        Dilemma(id: "wyr_077", a: "La langue d'un chien", b: "Les dents d'un cheval"),
        Dilemma(id: "wyr_078", a: "Ton prochain pet est un vrai caca", b: "Ton prochain rot est du vomi"),
        Dilemma(id: "wyr_079", a: "Manger une couche usagée", b: "Boire un verre de pipi de quelqu'un d'ici"),
        Dilemma(id: "wyr_080", a: "Faire l'amour devant tes beaux-parents une fois", b: "Les entendre à chaque fois"),
        Dilemma(id: "wyr_081", a: "Refaire ta première fois devant témoins", b: "La raconter en détail à ta famille"),
        Dilemma(id: "wyr_082", a: "Roter au premier baiser", b: "Éternuer dans le cou à chaque câlin"),
        Dilemma(id: "wyr_083", a: "Péter pendant un massage en couple", b: "Pendant une demande en mariage"),
        Dilemma(id: "wyr_084", a: "Faire ça dans le lit de tes parents", b: "Que tes parents le fassent dans le tien"),
        Dilemma(id: "wyr_085", a: "Vomir sur ton crush", b: "Que ton crush vomisse sur toi"),
        Dilemma(id: "wyr_086", a: "Danser nu une minute en boîte", b: "Courir nu autour du pâté de maisons"),
        Dilemma(id: "wyr_087", a: "Manger un kebab trouvé dans le bus", b: "Boire une bière ouverte trouvée en boîte"),
        Dilemma(id: "wyr_088", a: "Crier le mauvais prénom une fois", b: "L'entendre à chaque fois"),
        Dilemma(id: "wyr_089", a: "Passer une nuit menotté à un inconnu", b: "À ton ex le plus toxique"),
        Dilemma(id: "wyr_090", a: "Zéro préliminaires pour toujours", b: "Rien que ça, jamais la suite")
    ]
